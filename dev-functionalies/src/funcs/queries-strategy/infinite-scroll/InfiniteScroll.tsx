...
const InfiniteScroll: React.FC = () => {
  ...
  return (
    <Container>
      <h1 style={{color: "#ccc", marginTop: "2.5rem", textAlign: "center"}}>Rick and Morty Characters</h1>
        <button style={{width: "35rem", margin: "0 auto"}} onClick={handleResetData}>Reset Data</button>
      <CharacterContent>
